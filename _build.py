...
# Applies to the RSVP button and the Share link on UPCOMING cards only —
# a past event keeps its original listing URL, so "View details" never lands a
# visitor on a registration form that has since been closed.
_RSVP_OVERRIDES = {
  ...
  <div class="wrap">
    <div class="grid-2">
      ...
      <div>
        ...
        <p style="opacity:.85;margin-top:12px;">Meet Terrance, an alumnus of our construction trade training program. From taking orders at Starbucks to a proud member of the Roofers Union — and now he's helping build the roof of the LEO Center.</p>
        <div style="margin-top:24px;display:flex;gap:12px;flex-wrap:wrap;">
...
<section class="section">
  <div class="wrap" style="text-align:center;">
    ...
    <p style="font-size:var(--fs-lead);max-width:640px;margin:0 auto;color:var(--muted);">Our next cohort begins November 2026. Complete the application below to be considered &mdash; questions? Reach out to Tawanna Cotten at <a href="mailto:tawannacotten@projecthood.org">tawannacotten@projecthood.org</a>.</p>
    {_cc_apply}
  </div>
</section>
...
<section class="hero bg-black">
  <div class="wrap" style="display:flex;flex-wrap:wrap;gap:var(--sp-4);align-items:center;justify-content:space-between;">
    ...
    <div style="flex:0 0 auto;text-align:center;">
      <img src="img/qr-annual-report.png" alt="QR code linking to the Project H.O.O.D. 2025 Annual Report" width="200" height="200" style="width:200px;max-width:56vw;height:auto;border-radius:14px;padding:14px;background:var(--white);display:block;margin:0 auto;box-shadow:0 12px 40px rgba(0,0,0,.45);">
      <p style="color:rgba(255,255,255,.85);font-family:var(--font-display);letter-spacing:.06em;text-transform:uppercase;font-size:12.5px;margin-top:12px;">Scan to open &amp; share</p>
    </div>
  </div>
</section>
