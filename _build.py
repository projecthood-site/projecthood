...
<section class="section" id="share-report">
  <div class="wrap grid-2" style="align-items:center;">
    <div style="text-align:center;">
      <img src="img/qr-annual-report.png" alt="QR code linking to the Project H.O.O.D. 2025 Annual Report" width="240" height="240" loading="lazy" style="width:240px;max-width:100%;height:auto;border:1px solid var(--line);border-radius:12px;padding:14px;background:var(--white);">
    </div>
    <div>
      <div class="eyebrow" style="color:var(--green);">Share the report</div>
      <h2>Scan to open &amp; share.</h2>
      <p>Point a phone camera at the code to open the 2025 Annual Report instantly &mdash; then pass it on. Great for events, printed materials, and slides.</p>
      <p style="font-family:var(--font-display);letter-spacing:.04em;font-size:15px;"><a href="https://projecthood.org/annual-report">projecthood.org/annual-report</a></p>
    </div>
  </div>
</section>
